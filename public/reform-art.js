...
export function heroArt() {
  return `<div class="hero-art" aria-label="Five connected reforms: spending, tax, rules, energy and migration"><div class="art-orbit orbit-one"></div><div class="art-orbit orbit-two"></div><div class="art-centre"><span>THE AIM</span><strong>Prosperity<br>per person</strong><svg viewBox="0 0 120 55" aria-hidden="true"><path d="M8 44L42 30l22 5 44-25m-25 0h25v25" fill="none" stroke="#f6bb42" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/></svg></div>${["SPENDING", "TAX", "RULES", "ENERGY", "MIGRATION"].map((t, i) => `<div class="art-node node-${i}">${policyIcon(i)}<span>${t}</span></div>`).join("")}<div class="art-caption">Five reforms. One direction.</div></div>`;
}
